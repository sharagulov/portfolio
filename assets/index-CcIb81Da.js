...
#endif`,y0="gl_FragColor = linearToOutputTexel( gl_FragColor );",T0=`vec4 LinearTransferOETF( in vec4 value ) {
	return value;
}
...
void main() {
	...
	`}function FA(i){let t=new WeakMap,e=null;function n(o){if(o&&o.isTexture){const l=o.mapping,c=l===Bl||l===zl,u=l===rs||l===ss;if(c||u){let f=t.get(o);const h=f!==void 0?f.texture.pmremVersion:0;if(o.isRenderTargetTexture&&o.pmremVersion!==h)return e===null&&(e=new hf(i)),f=c?e.fromEquirectangular(o,f):e.fromCubemap(o,f),f.texture.pmremVersion=o.pmremVersion,t.set(o,f),f.texture;if(f!==void 0)return f.texture;{const d=o.image;return c&&d&&d.height>0||u&&d&&r(d)?(e===null&&(e=new hf(i)),f=c?e.fromEquirectangular(o):e.fromCubemap(o),f.texture.pmremVersion=o.pmremVersion,t.set(o,f),o.addEventListener("dispose",s),f.texture):null}}}return o}function r(o){let l=0;const c=6;for(let u=0;u<c;u++)o[u]!==void 0&&l++;return l===c}function s(o){const l=o.target;l.removeEventListener("dispose",s);const c=t.get(l);c!==void 0&&(t.delete(l),c.dispose())}function a(){t=new WeakMap,e!==null&&(e.dispose(),e=null)}return{get:n,dispose:a}}function OA(i){const t={};function e(n){if(t[n]!==void 0)return t[n];let r;switch(n){case"WEBGL_depth_texture":r=i.getExtension("WEBGL_depth_texture")||i.getExtension("MOZ_WEBGL_depth_texture")||i.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":r=i.getExtension("EXT_texture_filter_anisotropic")||i.getExtension("MOZ_EXT_texture_filter_anisotropic")||i.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":r=i.getExtension("WEBGL_compressed_texture_s3tc")||i.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":r=i.getExtension("WEBGL_compressed_texture_pvrtc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:r=i.getExtension(n)}return t[n]=r,r}return{has:function(n){return e(n)!==null},init:function(){e("EXT_color_buffer_float"),e("WEBGL_clip_cull_distance"),e("OES_texture_float_linear"),e("EXT_color_buffer_half_float"),e("WEBGL_multisampled_render_to_texture"),e("WEBGL_render_shared_exponent")},get:function(n){const r=e(n);return r===null&&kr("THREE.WebGLRenderer: "+n+" extension not supported."),r}}}function BA(i,t,e,n){const r={},s=new WeakMap;function a(f){const h=f.target;h.index!==null&&t.remove(h.index);for(const g in h.attributes)t.remove(h.attributes[g]);h.removeEventListener("dispose",a),delete r[h.id];const d=s.get(h);d&&(t.remove(d),s.delete(h)),n.releaseStatesOfGeometry(h),h.isInstancedBufferGeometry===!0&&delete h._maxInstanceCount,e.memory.geometries--}function o(f,h){return r[h.id]===!0||(h.addEventListener("dispose",a),r[h.id]=!0,e.memory.geometries++),h}function l(f){const h=f.attributes;for(const d in h)t.update(h[d],i.ARRAY_BUFFER)}function c(f){const h=[],d=f.index,g=f.attributes.position;let _=0;if(d!==null){const y=d.array;_=d.version;for(let S=0,x=y.length;S<x;S+=3){const T=y[S+0],w=y[S+1],b=y[S+2];h.push(T,w,w,b,b,T)}}else if(g!==void 0){const y=g.array;_=g.version;for(let S=0,x=y.length/3-1;S<x;S+=3){const T=S+0,w=S+1,b=S+2;h.push(T,w,w,b,b,T)}}else return;const m=new(Sd(h)?Pd:Cd)(h,1);m.version=_;const p=s.get(f);p&&t.remove(p),s.set(f,m)}function u(f){const h=s.get(f);if(h){const d=f.index;d!==null&&h.version<d.version&&c(f)}else c(f);return s.get(f)}return{get:o,update:l,getWireframeAttribute:u}}function zA(i,t,e){let n;function r(h){n=h}let s,a;function o(h){s=h.type,a=h.bytesPerElement}function l(h,d){i.drawElements(n,d,s,h*a),e.update(d,n,1)}function c(h,d,g){g!==0&&(i.drawElementsInstanced(n,d,s,h*a,g),e.update(d,n,g))}function u(h,d,g){if(g===0)return;t.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,d,0,s,h,0,g);let m=0;for(let p=0;p<g;p++)m+=d[p];e.update(m,n,1)}function f(h,d,g,_){if(g===0)return;const m=t.get("WEBGL_multi_draw");if(m===null)for(let p=0;p<h.length;p++)c(h[p]/a,d[p],_[p]);else{m.multiDrawElementsInstancedWEBGL(n,d,0,s,h,0,_,0,g);let p=0;for(let y=0;y<g;y++)p+=d[y]*_[y];e.update(p,n,1)}}this.setMode=r,this.setIndex=o,this.render=l,this.renderInstances=c,this.renderMultiDraw=u,this.renderMultiDrawInstances=f}function kA(i){const t={geometries:0,textures:0},e={frame:0,calls:0,triangles:0,points:0,lines:0};function n(s,a,o){switch(e.calls++,a){case i.TRIANGLES:e.triangles+=o*(s/3);break;case i.LINES:e.lines+=o*(s/2);break;case i.LINE_STRIP:e.lines+=o*(s-1);break;case i.LINE_LOOP:e.lines+=o*s;break;case i.POINTS:e.points+=o*s;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",a);break}}function r(){e.calls=0,e.triangles=0,e.points=0,e.lines=0}return{memory:t,render:e,programs:null,autoReset:!0,reset:r,update:n}}function VA(i,t,e){const n=new WeakMap,r=new ve;function s(a,o,l){const c=a.morphTargetInfluences,u=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,f=u!==void 0?u.length:0;let h=n.get(o);if(h===void 0||h.count!==f){let M=function(){C.dispose(),n.delete(o),o.removeEventListener("dispose",M)};var d=M;h!==void 0&&h.texture.dispose();const g=o.morphAttributes.position!==void 0,_=o.morphAttributes.normal!==void 0,m=o.morphAttributes.color!==void 0,p=o.morphAttributes.position||[],y=o.morphAttributes.normal||[],S=o.morphAttributes.color||[];let x=0;g===!0&&(x=1),_===!0&&(x=2),m===!0&&(x=3);let T=o.attributes.position.count*x,w=1;T>t.maxTextureSize&&(w=Math.ceil(T/t.maxTextureSize),T=t.maxTextureSize);const b=new Float32Array(T*w*4*f),C=new yd(b,T,w,f);C.type=ni,C.needsUpdate=!0;const v=x*4;for(let P=0;P<f;P++){const z=p[P],N=y[P],X=S[P],q=T*w*4*P;for(let V=0;V<z.count;V++){const Y=V*v;g===!0&&(r.fromBufferAttribute(z,V),b[q+Y+0]=r.x,b[q+Y+1]=r.y,b[q+Y+2]=r.z,b[q+Y+3]=0),_===!0&&(r.fromBufferAttribute(N,V),b[q+Y+4]=r.x,b[q+Y+5]=r.y,b[q+Y+6]=r.z,b[q+Y+7]=0),m===!0&&(r.fromBufferAttribute(X,V),b[q+Y+8]=r.x,b[q+Y+9]=r.y,b[q+Y+10]=r.z,b[q+Y+11]=X.itemSize===4?r.w:1)}}h={count:f,texture:C,size:new te(T,w)},n.set(o,h),o.addEventListener("dispose",M)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)l.getUniforms().setValue(i,"morphTexture",a.morphTexture,e);else{let g=0;for(let m=0;m<c.length;m++)g+=c[m];const _=o.morphTargetsRelative?1:1-g;l.getUniforms().setValue(i,"morphTargetBaseInfluence",_),l.getUniforms().setValue(i,"morphTargetInfluences",c)}l.getUniforms().setValue(i,"morphTargetsTexture",h.texture,e),l.getUniforms().setValue(i,"morphTargetsTextureSize",h.size)}return{update:s}}function HA(i,t,e,n){let r=new WeakMap;function s(l){const c=n.render.frame,u=l.geometry,f=t.get(l,u);if(r.get(f)!==c&&(t.update(f),r.set(f,c)),l.isInstancedMesh&&(l.hasEventListener("dispose",o)===!1&&l.addEventListener("dispose",o),r.get(l)!==c&&(e.update(l.instanceMatrix,i.ARRAY_BUFFER),l.instanceColor!==null&&e.update(l.instanceColor,i.ARRAY_BUFFER),r.set(l,c))),l.isSkinnedMesh){const h=l.skeleton;r.get(h)!==c&&(h.update(),r.set(h,c))}return f}function a(){r=new WeakMap}function o(l){const c=l.target;c.removeEventListener("dispose",o),e.remove(c.instanceMatrix),c.instanceColor!==null&&e.remove(c.instanceColor)}return{update:s,dispose:a}}const Od=new Ke,_f=new Nd(1,1),Bd=new yd,zd=new xv,kd=new Id,gf=[],vf=[],xf=new Float32Array(16),Af=new Float32Array(9),Mf=new Float32Array(4);function ps(i,t,e){const n=i[0];if(n<=0||n>0)return i;const r=t*e;let s=gf[r];if(s===void 0&&(s=new Float32Array(r),gf[r]=s),t!==0){n.toArray(s,0);for(let a=1,o=0;a!==t;++a)o+=e,i[a].toArray(s,o)}return s}function ye(i,t){if(i.length!==t.length)return!1;for(let e=0,n=i.length;e<n;e++)if(i[e]!==t[e])return!1;return!0}function Te(i,t){for(let e=0,n=t.length;e<n;e++)i[e]=t[e]}function ho(i,t){let e=vf[t];e===void 0&&(e=new Int32Array(t),vf[t]=e);for(let n=0;n!==t;++n)e[n]=i.allocateTextureUnit();return e}function GA(i,t){const e=this.cache;e[0]!==t&&(i.uniform1f(this.addr,t),e[0]=t)}function WA(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(i.uniform2f(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(ye(e,t))return;i.uniform2fv(this.addr,t),Te(e,t)}}function XA(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(i.uniform3f(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else if(t.r!==void 0)(e[0]!==t.r||e[1]!==t.g||e[2]!==t.b)&&(i.uniform3f(this.addr,t.r,t.g,t.b),e[0]=t.r,e[1]=t.g,e[2]=t.b);else{if(ye(e,t))return;i.uniform3fv(this.addr,t),Te(e,t)}}function qA(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(i.uniform4f(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(ye(e,t))return;i.uniform4fv(this.addr,t),Te(e,t)}}function YA(i,t){const e=this.cache,n=t.elements;if(n===void 0){if(ye(e,t))return;i.uniformMatrix2fv(this.addr,!1,t),Te(e,t)}else{if(ye(e,n))return;Mf.set(n),i.uniformMatrix2fv(this.addr,!1,Mf),Te(e,n)}}function $A(i,t){const e=this.cache,n=t.elements;if(n===void 0){if(ye(e,t))return;i.uniformMatrix3fv(this.addr,!1,t),Te(e,t)}else{if(ye(e,n))return;Af.set(n),i.uniformMatrix3fv(this.addr,!1,Af),Te(e,n)}}function jA(i,t){const e=this.cache,n=t.elements;if(n===void 0){if(ye(e,t))return;i.uniformMatrix4fv(this.addr,!1,t),Te(e,t)}else{if(ye(e,n))return;xf.set(n),i.uniformMatrix4fv(this.addr,!1,xf),Te(e,n)}}function KA(i,t){const e=this.cache;e[0]!==t&&(i.uniform1i(this.addr,t),e[0]=t)}function ZA(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(i.uniform2i(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(ye(e,t))return;i.uniform2iv(this.addr,t),Te(e,t)}}function JA(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(i.uniform3i(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(ye(e,t))return;i.uniform3iv(this.addr,t),Te(e,t)}}function QA(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(i.uniform4i(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(ye(e,t))return;i.uniform4iv(this.addr,t),Te(e,t)}}function tM(i,t){const e=this.cache;e[0]!==t&&(i.uniform1ui(this.addr,t),e[0]=t)}function eM(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(i.uniform2ui(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(ye(e,t))return;i.uniform2uiv(this.addr,t),Te(e,t)}}function nM(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(i.uniform3ui(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(ye(e,t))return;i.uniform3uiv(this.addr,t),Te(e,t)}}function iM(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(i.uniform4ui(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(ye(e,t))return;i.uniform4uiv(this.addr,t),Te(e,t)}}function rM(i,t,e){const n=this.cache,r=e.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r);let s;this.type===i.SAMPLER_2D_SHADOW?(_f.compareFunction=Md,s=_f):s=Od,e.setTexture2D(t||s,r)}function sM(i,t,e){const n=this.cache,r=e.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),e.setTexture3D(t||zd,r)}function aM(i,t,e){const n=this.cache,r=e.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),e.setTextureCube(t||kd,r)}function oM(i,t,e){const n=this.cache,r=e.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),e.setTexture2DArray(t||Bd,r)}function lM(i){switch(i){case 5126:return GA;case 35664:return WA;case 35665:return XA;case 35666:return qA;case 35674:return YA;case 35675:return $A;case 35676:return jA;case 5124:case 35670:return KA;case 35667:case 35671:return ZA;case 35668:case 35672:return JA;case 35669:case 35673:return QA;case 5125:return tM;case 36294:return eM;case 36295:return nM;case 36296:return iM;case 35678:case 36198:case 36298:case 36306:case 35682:return rM;case 35679:case 36299:case 36307:return sM;case 35680:case 36300:case 36308:case 36293:return aM;case 36289:case 36303:case 36311:case 36292:return oM}}function cM(i,t){i.uniform1fv(this.addr,t)}function uM(i,t){const e=ps(t,this.size,2);i.uniform2fv(this.addr,e)}function fM(i,t){const e=ps(t,this.size,3);i.uniform3fv(this.addr,e)}function hM(i,t){const e=ps(t,this.size,4);i.uniform4fv(this.addr,e)}function dM(i,t){const e=ps(t,this.size,4);i.uniformMatrix2fv(this.addr,!1,e)}function pM(i,t){const e=ps(t,this.size,9);i.uniformMatrix3fv(this.addr,!1,e)}function mM(i,t){const e=ps(t,this.size,16);i.uniformMatrix4fv(this.addr,!1,e)}function _M(i,t){i.uniform1iv(this.addr,t)}function gM(i,t){i.uniform2iv(this.addr,t)}function vM(i,t){i.uniform3iv(this.addr,t)}function xM(i,t){i.uniform4iv(this.addr,t)}function AM(i,t){i.uniform1uiv(this.addr,t)}function MM(i,t){i.uniform2uiv(this.addr,t)}function SM(i,t){i.uniform3uiv(this.addr,t)}function EM(i,t){i.uniform4uiv(this.addr,t)}function yM(i,t,e){const n=this.cache,r=t.length,s=ho(e,r);ye(n,s)||(i.uniform1iv(this.addr,s),Te(n,s));for(let a=0;a!==r;++a)e.setTexture2D(t[a]||Od,s[a])}function TM(i,t,e){const n=this.cache,r=t.length,s=ho(e,r);ye(n,s)||(i.uniform1iv(this.addr,s),Te(n,s));for(let a=0;a!==r;++a)e.setTexture3D(t[a]||zd,s[a])}function bM(i,t,e){const n=this.cache,r=t.length,s=ho(e,r);ye(n,s)||(i.uniform1iv(this.addr,s),Te(n,s));for(let a=0;a!==r;++a)e.setTextureCube(t[a]||kd,s[a])}function wM(i,t,e){const n=this.cache,r=t.length,s=ho(e,r);ye(n,s)||(i.uniform1iv(this.addr,s),Te(n,s));for(let a=0;a!==r;++a)e.setTexture2DArray(t[a]||Bd,s[a])}function RM(i){switch(i){case 5126:return cM;case 35664:return uM;case 35665:return fM;case 35666:return hM;case 35674:return dM;case 35675:return pM;case 35676:return mM;case 5124:case 35670:return _M;case 35667:case 35671:return gM;case 35668:case 35672:return vM;case 35669:case 35673:return xM;case 5125:return AM;case 36294:return MM;case 36295:return SM;case 36296:return EM;case 35678:case 36198:case 36298:case 36306:case 35682:return yM;case 35679:case 36299:case 36307:return TM;case 35680:case 36300:case 36308:case 36293:return bM;case 36289:case 36303:case 36311:case 36292:return wM}}class CM{constructor(t,e,n){this.id=t,this.addr=n,this.cache=[],this.type=e.type,this.setValue=lM(e.type)}}class PM{constructor(t,e,n){this.id=t,this.addr=n,this.cache=[],this.type=e.type,this.size=e.size,this.setValue=RM(e.type)}}class DM{constructor(t){this.id=t,this.seq=[],this.map={}}setValue(t,e,n){const r=this.seq;for(let s=0,a=r.length;s!==a;++s){const o=r[s];o.setValue(t,e[o.id],n)}}}const el=/(\w+)(\])?(\[|\.)?/g;function Sf(i,t){i.seq.push(t),i.map[t.id]=t}function LM(i,t,e){const n=i.name,r=n.length;for(el.lastIndex=0;;){const s=el.exec(n),a=el.lastIndex;let o=s[1];const l=s[2]==="]",c=s[3];if(l&&(o=o|0),c===void 0||c==="["&&a+2===r){Sf(e,c===void 0?new CM(o,i,t):new PM(o,i,t));break}else{let f=e.map[o];f===void 0&&(f=new DM(o),Sf(e,f)),e=f}}}class Na{constructor(t,e){this.seq=[],this.map={};const n=t.getProgramParameter(e,t.ACTIVE_UNIFORMS);for(let r=0;r<n;++r){const s=t.getActiveUniform(e,r),a=t.getUniformLocation(e,s.name);LM(s,a,this)}}setValue(t,e,n,r){const s=this.map[e];s!==void 0&&s.setValue(t,n,r)}setOptional(t,e,n){const r=e[n];r!==void 0&&this.setValue(t,n,r)}static upload(t,e,n,r){for(let s=0,a=e.length;s!==a;++s){const o=e[s],l=n[o.id];l.needsUpdate!==!1&&o.setValue(t,l.value,r)}}static seqWithValue(t,e){const n=[];for(let r=0,s=t.length;r!==s;++r){const a=t[r];a.id in e&&n.push(a)}return n}}function Ef(i,t,e){const n=i.createShader(t);return i.shaderSource(n,e),i.compileShader(n),n}const IM=37297;let UM=0;function NM(i,t){const e=i.split(`
`),n=[],r=Math.max(t-6,0),s=Math.min(t+6,e.length);for(let a=r;a<s;a++){const o=a+1;n.push(`${o===t?">":" "} ${o}: ${e[a]}`)}return n.join(`
`)}const yf=new Lt;function FM(i){qt._getMatrix(yf,qt.workingColorSpace,i);const t=`mat3( ${yf.elements.map(e=>e.toFixed(4))} )`;switch(qt.getTransfer(i)){case Za:return[t,"LinearTransferOETF"];case Zt:return[t,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space: ",i),[t,"LinearTransferOETF"]}}function Tf(i,t,e){const n=i.getShaderParameter(t,i.COMPILE_STATUS),r=i.getShaderInfoLog(t).trim();if(n&&r==="")return"";const s=/ERROR: 0:(\d+)/.exec(r);if(s){const a=parseInt(s[1]);return e.toUpperCase()+`
...
`)}function BM(i,t){let e;switch(t){case Wg:e="Linear";break;case Xg:e="Reinhard";break;case qg:e="Cineon";break;case Yg:e="ACESFilmic";break;case jg:e="AgX";break;case Kg:e="Neutral";break;case $g:e="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",t),e="Linear"}return"vec3 "+i+"( vec3 color ) { return "+e+"ToneMapping( color ); }"}const Ta=new G;function zM(){qt.getLuminanceCoefficients(Ta);const i=Ta.x.toFixed(4),t=Ta.y.toFixed(4),e=Ta.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${t}, ${e} );`,"	return dot( weights, rgb );","}"].join(`
...
#define LOW_PRECISION`),t}function $M(i){let t="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===ld?t="SHADOWMAP_TYPE_PCF":i.shadowMapType===Eg?t="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===Zn&&(t="SHADOWMAP_TYPE_VSM"),t}function jM(i){let t="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case rs:case ss:t="ENVMAP_TYPE_CUBE";break;case co:t="ENVMAP_TYPE_CUBE_UV";break}return t}function KM(i){let t="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case ss:t="ENVMAP_MODE_REFRACTION";break}return t}function ZM(i){let t="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case cd:t="ENVMAP_BLENDING_MULTIPLY";break;case Hg:t="ENVMAP_BLENDING_MIX";break;case Gg:t="ENVMAP_BLENDING_ADD";break}return t}function JM(i){const t=i.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:n,maxMip:e}}function QM(i,t,e,n){const r=i.getContext(),s=e.defines;let a=e.vertexShader,o=e.fragmentShader;const l=$M(e),c=jM(e),u=KM(e),f=ZM(e),h=JM(e),d=kM(e),g=VM(s),_=r.createProgram();let m,p,y=e.glslVersion?"#version "+e.glslVersion+`
...
}`;function mS(i,t,e){let n=new Ud;const r=new te,s=new te,a=new ve,o=new Vv({depthPacking:Qg}),l=new Hv,c={},u=e.maxTextureSize,f={[Ni]:je,[je]:Ni,[ei]:ei},h=new ui({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new te},radius:{value:4}},vertexShader:dS,fragmentShader:pS}),d=h.clone();d.defines.HORIZONTAL_PASS=1;const g=new fi;g.setAttribute("position",new cn(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const _=new ri(g,h),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=ld;let p=this.type;this.render=function(w,b,C){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||w.length===0)return;const v=i.getRenderTarget(),M=i.getActiveCubeFace(),P=i.getActiveMipmapLevel(),z=i.state;z.setBlending(wi),z.buffers.color.setClear(1,1,1,1),z.buffers.depth.setTest(!0),z.setScissorTest(!1);const N=p!==Zn&&this.type===Zn,X=p===Zn&&this.type!==Zn;for(let q=0,V=w.length;q<V;q++){const Y=w[q],H=Y.shadow;if(H===void 0){console.warn("THREE.WebGLShadowMap:",Y,"has no shadow.");continue}if(H.autoUpdate===!1&&H.needsUpdate===!1)continue;r.copy(H.mapSize);const nt=H.getFrameExtents();if(r.multiply(nt),s.copy(H.mapSize),(r.x>u||r.y>u)&&(r.x>u&&(s.x=Math.floor(u/nt.x),r.x=s.x*nt.x,H.mapSize.x=s.x),r.y>u&&(s.y=Math.floor(u/nt.y),r.y=s.y*nt.y,H.mapSize.y=s.y)),H.map===null||N===!0||X===!0){const gt=this.type!==Zn?{minFilter:Pn,magFilter:Pn}:{};H.map!==null&&H.map.dispose(),H.map=new _r(r.x,r.y,gt),H.map.texture.name=Y.name+".shadowMap",H.camera.updateProjectionMatrix()}i.setRenderTarget(H.map),i.clear();const at=H.getViewportCount();for(let gt=0;gt<at;gt++){const bt=H.getViewport(gt);a.set(s.x*bt.x,s.y*bt.y,s.x*bt.z,s.y*bt.w),z.viewport(a),H.updateMatrices(Y,gt),n=H.getFrustum(),x(b,C,H.camera,Y,this.type)}H.isPointLightShadow!==!0&&this.type===Zn&&y(H,C),H.needsUpdate=!1}p=this.type,m.needsUpdate=!1,i.setRenderTarget(v,M,P)};function y(w,b){const C=t.update(_);h.defines.VSM_SAMPLES!==w.blurSamples&&(h.defines.VSM_SAMPLES=w.blurSamples,d.defines.VSM_SAMPLES=w.blurSamples,h.needsUpdate=!0,d.needsUpdate=!0),w.mapPass===null&&(w.mapPass=new _r(r.x,r.y)),h.uniforms.shadow_pass.value=w.map.texture,h.uniforms.resolution.value=w.mapSize,h.uniforms.radius.value=w.radius,i.setRenderTarget(w.mapPass),i.clear(),i.renderBufferDirect(b,null,C,h,_,null),d.uniforms.shadow_pass.value=w.mapPass.texture,d.uniforms.resolution.value=w.mapSize,d.uniforms.radius.value=w.radius,i.setRenderTarget(w.map),i.clear(),i.renderBufferDirect(b,null,C,d,_,null)}function S(w,b,C,v){let M=null;const P=C.isPointLight===!0?w.customDistanceMaterial:w.customDepthMaterial;if(P!==void 0)M=P;else if(M=C.isPointLight===!0?l:o,i.localClippingEnabled&&b.clipShadows===!0&&Array.isArray(b.clippingPlanes)&&b.clippingPlanes.length!==0||b.displacementMap&&b.displacementScale!==0||b.alphaMap&&b.alphaTest>0||b.map&&b.alphaTest>0){const z=M.uuid,N=b.uuid;let X=c[z];X===void 0&&(X={},c[z]=X);let q=X[N];q===void 0&&(q=M.clone(),X[N]=q,b.addEventListener("dispose",T)),M=q}if(M.visible=b.visible,M.wireframe=b.wireframe,v===Zn?M.side=b.shadowSide!==null?b.shadowSide:b.side:M.side=b.shadowSide!==null?b.shadowSide:f[b.side],M.alphaMap=b.alphaMap,M.alphaTest=b.alphaTest,M.map=b.map,M.clipShadows=b.clipShadows,M.clippingPlanes=b.clippingPlanes,M.clipIntersection=b.clipIntersection,M.displacementMap=b.displacementMap,M.displacementScale=b.displacementScale,M.displacementBias=b.displacementBias,M.wireframeLinewidth=b.wireframeLinewidth,M.linewidth=b.linewidth,C.isPointLight===!0&&M.isMeshDistanceMaterial===!0){const z=i.properties.get(M);z.light=C}return M}function x(w,b,C,v,M){if(w.visible===!1)return;if(w.layers.test(b.layers)&&(w.isMesh||w.isLine||w.isPoints)&&(w.castShadow||w.receiveShadow&&M===Zn)&&(!w.frustumCulled||n.intersectsObject(w))){w.modelViewMatrix.multiplyMatrices(C.matrixWorldInverse,w.matrixWorld);const N=t.update(w),X=w.material;if(Array.isArray(X)){const q=N.groups;for(let V=0,Y=q.length;V<Y;V++){const H=q[V],nt=X[H.materialIndex];if(nt&&nt.visible){const at=S(w,nt,v,M);w.onBeforeShadow(i,w,b,C,N,at,H),i.renderBufferDirect(C,null,N,at,w,H),w.onAfterShadow(i,w,b,C,N,at,H)}}}else if(X.visible){const q=S(w,X,v,M);w.onBeforeShadow(i,w,b,C,N,q,null),i.renderBufferDirect(C,null,N,q,w,null),w.onAfterShadow(i,w,b,C,N,q,null)}}const z=w.children;for(let N=0,X=z.length;N<X;N++)x(z[N],b,C,v,M)}function T(w){w.target.removeEventListener("dispose",T);for(const C in c){const v=c[C],M=w.target.uuid;M in v&&(v[M].dispose(),delete v[M])}}}const _S={[Dl]:Ll,[Il]:Fl,[Ul]:Ol,[is]:Nl,[Ll]:Dl,[Fl]:Il,[Ol]:Ul,[Nl]:is};function gS(i,t){function e(){let L=!1;const ot=new ve;let W=null;const Z=new ve(0,0,0,0);return{setMask:function(ht){W!==ht&&!L&&(i.colorMask(ht,ht,ht,ht),W=ht)},setLocked:function(ht){L=ht},setClear:function(ht,ut,Dt,fe,De){De===!0&&(ht*=fe,ut*=fe,Dt*=fe),ot.set(ht,ut,Dt,fe),Z.equals(ot)===!1&&(i.clearColor(ht,ut,Dt,fe),Z.copy(ot))},reset:function(){L=!1,W=null,Z.set(-1,0,0,0)}}}function n(){let L=!1,ot=!1,W=null,Z=null,ht=null;return{setReversed:function(ut){if(ot!==ut){const Dt=t.get("EXT_clip_control");ot?Dt.clipControlEXT(Dt.LOWER_LEFT_EXT,Dt.ZERO_TO_ONE_EXT):Dt.clipControlEXT(Dt.LOWER_LEFT_EXT,Dt.NEGATIVE_ONE_TO_ONE_EXT);const fe=ht;ht=null,this.setClear(fe)}ot=ut},getReversed:function(){return ot},setTest:function(ut){ut?Q(i.DEPTH_TEST):At(i.DEPTH_TEST)},setMask:function(ut){W!==ut&&!L&&(i.depthMask(ut),W=ut)},setFunc:function(ut){if(ot&&(ut=_S[ut]),Z!==ut){switch(ut){case Dl:i.depthFunc(i.NEVER);break;case Ll:i.depthFunc(i.ALWAYS);break;case Il:i.depthFunc(i.LESS);break;case is:i.depthFunc(i.LEQUAL);break;case Ul:i.depthFunc(i.EQUAL);break;case Nl:i.depthFunc(i.GEQUAL);break;case Fl:i.depthFunc(i.GREATER);break;case Ol:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}Z=ut}},setLocked:function(ut){L=ut},setClear:function(ut){ht!==ut&&(ot&&(ut=1-ut),i.clearDepth(ut),ht=ut)},reset:function(){L=!1,W=null,Z=null,ht=null,ot=!1}}}function r(){let L=!1,ot=null,W=null,Z=null,ht=null,ut=null,Dt=null,fe=null,De=null;return{setTest:function(jt){L||(jt?Q(i.STENCIL_TEST):At(i.STENCIL_TEST))},setMask:function(jt){ot!==jt&&!L&&(i.stencilMask(jt),ot=jt)},setFunc:function(jt,En,Xn){(W!==jt||Z!==En||ht!==Xn)&&(i.stencilFunc(jt,En,Xn),W=jt,Z=En,ht=Xn)},setOp:function(jt,En,Xn){(ut!==jt||Dt!==En||fe!==Xn)&&(i.stencilOp(jt,En,Xn),ut=jt,Dt=En,fe=Xn)},setLocked:function(jt){L=jt},setClear:function(jt){De!==jt&&(i.clearStencil(jt),De=jt)},reset:function(){L=!1,ot=null,W=null,Z=null,ht=null,ut=null,Dt=null,fe=null,De=null}}}const s=new e,a=new n,o=new r,l=new WeakMap,c=new WeakMap;let u={},f={},h=new WeakMap,d=[],g=null,_=!1,m=null,p=null,y=null,S=null,x=null,T=null,w=null,b=new Kt(0,0,0),C=0,v=!1,M=null,P=null,z=null,N=null,X=null;const q=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let V=!1,Y=0;const H=i.getParameter(i.VERSION);H.indexOf("WebGL")!==-1?(Y=parseFloat(/^WebGL (\d)/.exec(H)[1]),V=Y>=1):H.indexOf("OpenGL ES")!==-1&&(Y=parseFloat(/^OpenGL ES (\d)/.exec(H)[1]),V=Y>=2);let nt=null,at={};const gt=i.getParameter(i.SCISSOR_BOX),bt=i.getParameter(i.VIEWPORT),ft=new ve().fromArray(gt),F=new ve().fromArray(bt);function $(L,ot,W,Z){const ht=new Uint8Array(4),ut=i.createTexture();i.bindTexture(L,ut),i.texParameteri(L,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(L,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let Dt=0;Dt<W;Dt++)L===i.TEXTURE_3D||L===i.TEXTURE_2D_ARRAY?i.texImage3D(ot,0,i.RGBA,1,1,Z,0,i.RGBA,i.UNSIGNED_BYTE,ht):i.texImage2D(ot+Dt,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,ht);return ut}const rt={};rt[i.TEXTURE_2D]=$(i.TEXTURE_2D,i.TEXTURE_2D,1),rt[i.TEXTURE_CUBE_MAP]=$(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),rt[i.TEXTURE_2D_ARRAY]=$(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),rt[i.TEXTURE_3D]=$(i.TEXTURE_3D,i.TEXTURE_3D,1,1),s.setClear(0,0,0,1),a.setClear(1),o.setClear(0),Q(i.DEPTH_TEST),a.setFunc(is),kt(!1),Vt(Uu),Q(i.CULL_FACE),D(wi);function Q(L){u[L]!==!0&&(i.enable(L),u[L]=!0)}function At(L){u[L]!==!1&&(i.disable(L),u[L]=!1)}function Ct(L,ot){return f[L]!==ot?(i.bindFramebuffer(L,ot),f[L]=ot,L===i.DRAW_FRAMEBUFFER&&(f[i.FRAMEBUFFER]=ot),L===i.FRAMEBUFFER&&(f[i.DRAW_FRAMEBUFFER]=ot),!0):!1}function Nt(L,ot){let W=d,Z=!1;if(L){W=h.get(ot),W===void 0&&(W=[],h.set(ot,W));const ht=L.textures;if(W.length!==ht.length||W[0]!==i.COLOR_ATTACHMENT0){for(let ut=0,Dt=ht.length;ut<Dt;ut++)W[ut]=i.COLOR_ATTACHMENT0+ut;W.length=ht.length,Z=!0}}else W[0]!==i.BACK&&(W[0]=i.BACK,Z=!0);Z&&i.drawBuffers(W)}function ie(L){return g!==L?(i.useProgram(L),g=L,!0):!1}const Ft={[Qi]:i.FUNC_ADD,[Tg]:i.FUNC_SUBTRACT,[bg]:i.FUNC_REVERSE_SUBTRACT};Ft[wg]=i.MIN,Ft[Rg]=i.MAX;const ae={[Cg]:i.ZERO,[Pg]:i.ONE,[Dg]:i.SRC_COLOR,[Cl]:i.SRC_ALPHA,[Og]:i.SRC_ALPHA_SATURATE,[Ng]:i.DST_COLOR,[Ig]:i.DST_ALPHA,[Lg]:i.ONE_MINUS_SRC_COLOR,[Pl]:i.ONE_MINUS_SRC_ALPHA,[Fg]:i.ONE_MINUS_DST_COLOR,[Ug]:i.ONE_MINUS_DST_ALPHA,[Bg]:i.CONSTANT_COLOR,[zg]:i.ONE_MINUS_CONSTANT_COLOR,[kg]:i.CONSTANT_ALPHA,[Vg]:i.ONE_MINUS_CONSTANT_ALPHA};function D(L,ot,W,Z,ht,ut,Dt,fe,De,jt){if(L===wi){_===!0&&(At(i.BLEND),_=!1);return}if(_===!1&&(Q(i.BLEND),_=!0),L!==yg){if(L!==m||jt!==v){if((p!==Qi||x!==Qi)&&(i.blendEquation(i.FUNC_ADD),p=Qi,x=Qi),jt)switch(L){case jr:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Nu:i.blendFunc(i.ONE,i.ONE);break;case Fu:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case Ou:i.blendFuncSeparate(i.ZERO,i.SRC_COLOR,i.ZERO,i.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",L);break}else switch(L){case jr:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Nu:i.blendFunc(i.SRC_ALPHA,i.ONE);break;case Fu:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case Ou:i.blendFunc(i.ZERO,i.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",L);break}y=null,S=null,T=null,w=null,b.set(0,0,0),C=0,m=L,v=jt}return}ht=ht||ot,ut=ut||W,Dt=Dt||Z,(ot!==p||ht!==x)&&(i.blendEquationSeparate(Ft[ot],Ft[ht]),p=ot,x=ht),(W!==y||Z!==S||ut!==T||Dt!==w)&&(i.blendFuncSeparate(ae[W],ae[Z],ae[ut],ae[Dt]),y=W,S=Z,T=ut,w=Dt),(fe.equals(b)===!1||De!==C)&&(i.blendColor(fe.r,fe.g,fe.b,De),b.copy(fe),C=De),m=L,v=!1}function fn(L,ot){L.side===ei?At(i.CULL_FACE):Q(i.CULL_FACE);let W=L.side===je;ot&&(W=!W),kt(W),L.blending===jr&&L.transparent===!1?D(wi):D(L.blending,L.blendEquation,L.blendSrc,L.blendDst,L.blendEquationAlpha,L.blendSrcAlpha,L.blendDstAlpha,L.blendColor,L.blendAlpha,L.premultipliedAlpha),a.setFunc(L.depthFunc),a.setTest(L.depthTest),a.setMask(L.depthWrite),s.setMask(L.colorWrite);const Z=L.stencilWrite;o.setTest(Z),Z&&(o.setMask(L.stencilWriteMask),o.setFunc(L.stencilFunc,L.stencilRef,L.stencilFuncMask),o.setOp(L.stencilFail,L.stencilZFail,L.stencilZPass)),re(L.polygonOffset,L.polygonOffsetFactor,L.polygonOffsetUnits),L.alphaToCoverage===!0?Q(i.SAMPLE_ALPHA_TO_COVERAGE):At(i.SAMPLE_ALPHA_TO_COVERAGE)}function kt(L){M!==L&&(L?i.frontFace(i.CW):i.frontFace(i.CCW),M=L)}function Vt(L){L!==Mg?(Q(i.CULL_FACE),L!==P&&(L===Uu?i.cullFace(i.BACK):L===Sg?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):At(i.CULL_FACE),P=L}function Mt(L){L!==z&&(V&&i.lineWidth(L),z=L)}function re(L,ot,W){L?(Q(i.POLYGON_OFFSET_FILL),(N!==ot||X!==W)&&(i.polygonOffset(ot,W),N=ot,X=W)):At(i.POLYGON_OFFSET_FILL)}function St(L){L?Q(i.SCISSOR_TEST):At(i.SCISSOR_TEST)}function R(L){L===void 0&&(L=i.TEXTURE0+q-1),nt!==L&&(i.activeTexture(L),nt=L)}function A(L,ot,W){W===void 0&&(nt===null?W=i.TEXTURE0+q-1:W=nt);let Z=at[W];Z===void 0&&(Z={type:void 0,texture:void 0},at[W]=Z),(Z.type!==L||Z.texture!==ot)&&(nt!==W&&(i.activeTexture(W),nt=W),i.bindTexture(L,ot||rt[L]),Z.type=L,Z.texture=ot)}function O(){const L=at[nt];L!==void 0&&L.type!==void 0&&(i.bindTexture(L.type,null),L.type=void 0,L.texture=void 0)}function K(){try{i.compressedTexImage2D.apply(i,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function J(){try{i.compressedTexImage3D.apply(i,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function j(){try{i.texSubImage2D.apply(i,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function xt(){try{i.texSubImage3D.apply(i,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function ct(){try{i.compressedTexSubImage2D.apply(i,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function pt(){try{i.compressedTexSubImage3D.apply(i,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function Gt(){try{i.texStorage2D.apply(i,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function et(){try{i.texStorage3D.apply(i,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function mt(){try{i.texImage2D.apply(i,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function Tt(){try{i.texImage3D.apply(i,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function wt(L){ft.equals(L)===!1&&(i.scissor(L.x,L.y,L.z,L.w),ft.copy(L))}function _t(L){F.equals(L)===!1&&(i.viewport(L.x,L.y,L.z,L.w),F.copy(L))}function Ht(L,ot){let W=c.get(ot);W===void 0&&(W=new WeakMap,c.set(ot,W));let Z=W.get(L);Z===void 0&&(Z=i.getUniformBlockIndex(ot,L.name),W.set(L,Z))}function It(L,ot){const Z=c.get(ot).get(L);l.get(ot)!==Z&&(i.uniformBlockBinding(ot,Z,L.__bindingPointIndex),l.set(ot,Z))}function ee(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),a.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),u={},nt=null,at={},f={},h=new WeakMap,d=[],g=null,_=!1,m=null,p=null,y=null,S=null,x=null,T=null,w=null,b=new Kt(0,0,0),C=0,v=!1,M=null,P=null,z=null,N=null,X=null,ft.set(0,0,i.canvas.width,i.canvas.height),F.set(0,0,i.canvas.width,i.canvas.height),s.reset(),a.reset(),o.reset()}return{buffers:{color:s,depth:a,stencil:o},enable:Q,disable:At,bindFramebuffer:Ct,drawBuffers:Nt,useProgram:ie,setBlending:D,setMaterial:fn,setFlipSided:kt,setCullFace:Vt,setLineWidth:Mt,setPolygonOffset:re,setScissorTest:St,activeTexture:R,bindTexture:A,unbindTexture:O,compressedTexImage2D:K,compressedTexImage3D:J,texImage2D:mt,texImage3D:Tt,updateUBOMapping:Ht,uniformBlockBinding:It,texStorage2D:Gt,texStorage3D:et,texSubImage2D:j,texSubImage3D:xt,compressedTexSubImage2D:ct,compressedTexSubImage3D:pt,scissor:wt,viewport:_t,reset:ee}}function vS(i,t,e,n,r,s,a){const o=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new te,u=new WeakMap;let f;const h=new WeakMap;let d=!1;try{d=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(R,A){return d?new OffscreenCanvas(R,A):Qa("canvas")}function _(R,A,O){let K=1;const J=St(R);if((J.width>O||J.height>O)&&(K=O/Math.max(J.width,J.height)),K<1)if(typeof HTMLImageElement<"u"&&R instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&R instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&R instanceof ImageBitmap||typeof VideoFrame<"u"&&R instanceof VideoFrame){const j=Math.floor(K*J.width),xt=Math.floor(K*J.height);f===void 0&&(f=g(j,xt));const ct=A?g(j,xt):f;return ct.width=j,ct.height=xt,ct.getContext("2d").drawImage(R,0,0,j,xt),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+J.width+"x"+J.height+") to ("+j+"x"+xt+")."),ct}else return"data"in R&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+J.width+"x"+J.height+")."),R;return R}function m(R){return R.generateMipmaps}function p(R){i.generateMipmap(R)}function y(R){return R.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:R.isWebGL3DRenderTarget?i.TEXTURE_3D:R.isWebGLArrayRenderTarget||R.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function S(R,A,O,K,J=!1){if(R!==null){if(i[R]!==void 0)return i[R];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+R+"'")}let j=A;if(A===i.RED&&(O===i.FLOAT&&(j=i.R32F),O===i.HALF_FLOAT&&(j=i.R16F),O===i.UNSIGNED_BYTE&&(j=i.R8)),A===i.RED_INTEGER&&(O===i.UNSIGNED_BYTE&&(j=i.R8UI),O===i.UNSIGNED_SHORT&&(j=i.R16UI),O===i.UNSIGNED_INT&&(j=i.R32UI),O===i.BYTE&&(j=i.R8I),O===i.SHORT&&(j=i.R16I),O===i.INT&&(j=i.R32I)),A===i.RG&&(O===i.FLOAT&&(j=i.RG32F),O===i.HALF_FLOAT&&(j=i.RG16F),O===i.UNSIGNED_BYTE&&(j=i.RG8)),A===i.RG_INTEGER&&(O===i.UNSIGNED_BYTE&&(j=i.RG8UI),O===i.UNSIGNED_SHORT&&(j=i.RG16UI),O===i.UNSIGNED_INT&&(j=i.RG32UI),O===i.BYTE&&(j=i.RG8I),O===i.SHORT&&(j=i.RG16I),O===i.INT&&(j=i.RG32I)),A===i.RGB_INTEGER&&(O===i.UNSIGNED_BYTE&&(j=i.RGB8UI),O===i.UNSIGNED_SHORT&&(j=i.RGB16UI),O===i.UNSIGNED_INT&&(j=i.RGB32UI),O===i.BYTE&&(j=i.RGB8I),O===i.SHORT&&(j=i.RGB16I),O===i.INT&&(j=i.RGB32I)),A===i.RGBA_INTEGER&&(O===i.UNSIGNED_BYTE&&(j=i.RGBA8UI),O===i.UNSIGNED_SHORT&&(j=i.RGBA16UI),O===i.UNSIGNED_INT&&(j=i.RGBA32UI),O===i.BYTE&&(j=i.RGBA8I),O===i.SHORT&&(j=i.RGBA16I),O===i.INT&&(j=i.RGBA32I)),A===i.RGB&&O===i.UNSIGNED_INT_5_9_9_9_REV&&(j=i.RGB9_E5),A===i.RGBA){const xt=J?Za:qt.getTransfer(K);O===i.FLOAT&&(j=i.RGBA32F),O===i.HALF_FLOAT&&(j=i.RGBA16F),O===i.UNSIGNED_BYTE&&(j=xt===Zt?i.SRGB8_ALPHA8:i.RGBA8),O===i.UNSIGNED_SHORT_4_4_4_4&&(j=i.RGBA4),O===i.UNSIGNED_SHORT_5_5_5_1&&(j=i.RGB5_A1)}return(j===i.R16F||j===i.R32F||j===i.RG16F||j===i.RG32F||j===i.RGBA16F||j===i.RGBA32F)&&t.get("EXT_color_buffer_float"),j}function x(R,A){let O;return R?A===null||A===mr||A===as?O=i.DEPTH24_STENCIL8:A===ni?O=i.DEPTH32F_STENCIL8:A===zs&&(O=i.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):A===null||A===mr||A===as?O=i.DEPTH_COMPONENT24:A===ni?O=i.DEPTH_COMPONENT32F:A===zs&&(O=i.DEPTH_COMPONENT16),O}function T(R,A){return m(R)===!0||R.isFramebufferTexture&&R.minFilter!==Pn&&R.minFilter!==Bn?Math.log2(Math.max(A.width,A.height))+1:R.mipmaps!==void 0&&R.mipmaps.length>0?R.mipmaps.length:R.isCompressedTexture&&Array.isArray(R.image)?A.mipmaps.length:1}function w(R){const A=R.target;A.removeEventListener("dispose",w),C(A),A.isVideoTexture&&u.delete(A)}function b(R){const A=R.target;A.removeEventListener("dispose",b),M(A)}function C(R){const A=n.get(R);if(A.__webglInit===void 0)return;const O=R.source,K=h.get(O);if(K){const J=K[A.__cacheKey];J.usedTimes--,J.usedTimes===0&&v(R),Object.keys(K).length===0&&h.delete(O)}n.remove(R)}function v(R){const A=n.get(R);i.deleteTexture(A.__webglTexture);const O=R.source,K=h.get(O);delete K[A.__cacheKey],a.memory.textures--}function M(R){const A=n.get(R);if(R.depthTexture&&(R.depthTexture.dispose(),n.remove(R.depthTexture)),R.isWebGLCubeRenderTarget)for(let K=0;K<6;K++){if(Array.isArray(A.__webglFramebuffer[K]))for(let J=0;J<A.__webglFramebuffer[K].length;J++)i.deleteFramebuffer(A.__webglFramebuffer[K][J]);else i.deleteFramebuffer(A.__webglFramebuffer[K]);A.__webglDepthbuffer&&i.deleteRenderbuffer(A.__webglDepthbuffer[K])}else{if(Array.isArray(A.__webglFramebuffer))for(let K=0;K<A.__webglFramebuffer.length;K++)i.deleteFramebuffer(A.__webglFramebuffer[K]);else i.deleteFramebuffer(A.__webglFramebuffer);if(A.__webglDepthbuffer&&i.deleteRenderbuffer(A.__webglDepthbuffer),A.__webglMultisampledFramebuffer&&i.deleteFramebuffer(A.__webglMultisampledFramebuffer),A.__webglColorRenderbuffer)for(let K=0;K<A.__webglColorRenderbuffer.length;K++)A.__webglColorRenderbuffer[K]&&i.deleteRenderbuffer(A.__webglColorRenderbuffer[K]);A.__webglDepthRenderbuffer&&i.deleteRenderbuffer(A.__webglDepthRenderbuffer)}const O=R.textures;for(let K=0,J=O.length;K<J;K++){const j=n.get(O[K]);j.__webglTexture&&(i.deleteTexture(j.__webglTexture),a.memory.textures--),n.remove(O[K])}n.remove(R)}let P=0;function z(){P=0}function N(){const R=P;return R>=r.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+R+" texture units while this GPU supports only "+r.maxTextures),P+=1,R}function X(R){const A=[];return A.push(R.wrapS),A.push(R.wrapT),A.push(R.wrapR||0),A.push(R.magFilter),A.push(R.minFilter),A.push(R.anisotropy),A.push(R.internalFormat),A.push(R.format),A.push(R.type),A.push(R.generateMipmaps),A.push(R.premultiplyAlpha),A.push(R.flipY),A.push(R.unpackAlignment),A.push(R.colorSpace),A.join()}function q(R,A){const O=n.get(R);if(R.isVideoTexture&&Mt(R),R.isRenderTargetTexture===!1&&R.version>0&&O.__version!==R.version){const K=R.image;if(K===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(K.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{F(O,R,A);return}}e.bindTexture(i.TEXTURE_2D,O.__webglTexture,i.TEXTURE0+A)}function V(R,A){const O=n.get(R);if(R.version>0&&O.__version!==R.version){F(O,R,A);return}e.bindTexture(i.TEXTURE_2D_ARRAY,O.__webglTexture,i.TEXTURE0+A)}function Y(R,A){const O=n.get(R);if(R.version>0&&O.__version!==R.version){F(O,R,A);return}e.bindTexture(i.TEXTURE_3D,O.__webglTexture,i.TEXTURE0+A)}function H(R,A){const O=n.get(R);if(R.version>0&&O.__version!==R.version){$(O,R,A);return}e.bindTexture(i.TEXTURE_CUBE_MAP,O.__webglTexture,i.TEXTURE0+A)}const nt={[kl]:i.REPEAT,[ir]:i.CLAMP_TO_EDGE,[Vl]:i.MIRRORED_REPEAT},at={[Pn]:i.NEAREST,[Zg]:i.NEAREST_MIPMAP_NEAREST,[na]:i.NEAREST_MIPMAP_LINEAR,[Bn]:i.LINEAR,[wo]:i.LINEAR_MIPMAP_NEAREST,[rr]:i.LINEAR_MIPMAP_LINEAR},gt={[nv]:i.NEVER,[lv]:i.ALWAYS,[iv]:i.LESS,[Md]:i.LEQUAL,[rv]:i.EQUAL,[ov]:i.GEQUAL,[sv]:i.GREATER,[av]:i.NOTEQUAL};function bt(R,A){if(A.type===ni&&t.has("OES_texture_float_linear")===!1&&(A.magFilter===Bn||A.magFilter===wo||A.magFilter===na||A.magFilter===rr||A.minFilter===Bn||A.minFilter===wo||A.minFilter===na||A.minFilter===rr)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(R,i.TEXTURE_WRAP_S,nt[A.wrapS]),i.texParameteri(R,i.TEXTURE_WRAP_T,nt[A.wrapT]),(R===i.TEXTURE_3D||R===i.TEXTURE_2D_ARRAY)&&i.texParameteri(R,i.TEXTURE_WRAP_R,nt[A.wrapR]),i.texParameteri(R,i.TEXTURE_MAG_FILTER,at[A.magFilter]),i.texParameteri(R,i.TEXTURE_MIN_FILTER,at[A.minFilter]),A.compareFunction&&(i.texParameteri(R,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(R,i.TEXTURE_COMPARE_FUNC,gt[A.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(A.magFilter===Pn||A.minFilter!==na&&A.minFilter!==rr||A.type===ni&&t.has("OES_texture_float_linear")===!1)return;if(A.anisotropy>1||n.get(A).__currentAnisotropy){const O=t.get("EXT_texture_filter_anisotropic");i.texParameterf(R,O.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(A.anisotropy,r.getMaxAnisotropy())),n.get(A).__currentAnisotropy=A.anisotropy}}}function ft(R,A){let O=!1;R.__webglInit===void 0&&(R.__webglInit=!0,A.addEventListener("dispose",w));const K=A.source;let J=h.get(K);J===void 0&&(J={},h.set(K,J));const j=X(A);if(j!==R.__cacheKey){J[j]===void 0&&(J[j]={texture:i.createTexture(),usedTimes:0},a.memory.textures++,O=!0),J[j].usedTimes++;const xt=J[R.__cacheKey];xt!==void 0&&(J[R.__cacheKey].usedTimes--,xt.usedTimes===0&&v(A)),R.__cacheKey=j,R.__webglTexture=J[j].texture}return O}function F(R,A,O){let K=i.TEXTURE_2D;(A.isDataArrayTexture||A.isCompressedArrayTexture)&&(K=i.TEXTURE_2D_ARRAY),A.isData3DTexture&&(K=i.TEXTURE_3D);const J=ft(R,A),j=A.source;e.bindTexture(K,R.__webglTexture,i.TEXTURE0+O);const xt=n.get(j);if(j.version!==xt.__version||J===!0){e.activeTexture(i.TEXTURE0+O);const ct=qt.getPrimaries(qt.workingColorSpace),pt=A.colorSpace===xi?null:qt.getPrimaries(A.colorSpace),Gt=A.colorSpace===xi||ct===pt?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,A.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,A.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,A.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Gt);let et=_(A.image,!1,r.maxTextureSize);et=re(A,et);const mt=s.convert(A.format,A.colorSpace),Tt=s.convert(A.type);let wt=S(A.internalFormat,mt,Tt,A.colorSpace,A.isVideoTexture);bt(K,A);let _t;const Ht=A.mipmaps,It=A.isVideoTexture!==!0,ee=xt.__version===void 0||J===!0,L=j.dataReady,ot=T(A,et);if(A.isDepthTexture)wt=x(A.format===os,A.type),ee&&(It?e.texStorage2D(i.TEXTURE_2D,1,wt,et.width,et.height):e.texImage2D(i.TEXTURE_2D,0,wt,et.width,et.height,0,mt,Tt,null));else if(A.isDataTexture)if(Ht.length>0){It&&ee&&e.texStorage2D(i.TEXTURE_2D,ot,wt,Ht[0].width,Ht[0].height);for(let W=0,Z=Ht.length;W<Z;W++)_t=Ht[W],It?L&&e.texSubImage2D(i.TEXTURE_2D,W,0,0,_t.width,_t.height,mt,Tt,_t.data):e.texImage2D(i.TEXTURE_2D,W,wt,_t.width,_t.height,0,mt,Tt,_t.data);A.generateMipmaps=!1}else It?(ee&&e.texStorage2D(i.TEXTURE_2D,ot,wt,et.width,et.height),L&&e.texSubImage2D(i.TEXTURE_2D,0,0,0,et.width,et.height,mt,Tt,et.data)):e.texImage2D(i.TEXTURE_2D,0,wt,et.width,et.height,0,mt,Tt,et.data);else if(A.isCompressedTexture)if(A.isCompressedArrayTexture){It&&ee&&e.texStorage3D(i.TEXTURE_2D_ARRAY,ot,wt,Ht[0].width,Ht[0].height,et.depth);for(let W=0,Z=Ht.length;W<Z;W++)if(_t=Ht[W],A.format!==Cn)if(mt!==null)if(It){if(L)if(A.layerUpdates.size>0){const ht=lf(_t.width,_t.height,A.format,A.type);for(const ut of A.layerUpdates){const Dt=_t.data.subarray(ut*ht/_t.data.BYTES_PER_ELEMENT,(ut+1)*ht/_t.data.BYTES_PER_ELEMENT);e.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,W,0,0,ut,_t.width,_t.height,1,mt,Dt)}A.clearLayerUpdates()}else e.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,W,0,0,0,_t.width,_t.height,et.depth,mt,_t.data)}else e.compressedTexImage3D(i.TEXTURE_2D_ARRAY,W,wt,_t.width,_t.height,et.depth,0,_t.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else It?L&&e.texSubImage3D(i.TEXTURE_2D_ARRAY,W,0,0,0,_t.width,_t.height,et.depth,mt,Tt,_t.data):e.texImage3D(i.TEXTURE_2D_ARRAY,W,wt,_t.width,_t.height,et.depth,0,mt,Tt,_t.data)}else{It&&ee&&e.texStorage2D(i.TEXTURE_2D,ot,wt,Ht[0].width,Ht[0].height);for(let W=0,Z=Ht.length;W<Z;W++)_t=Ht[W],A.format!==Cn?mt!==null?It?L&&e.compressedTexSubImage2D(i.TEXTURE_2D,W,0,0,_t.width,_t.height,mt,_t.data):e.compressedTexImage2D(i.TEXTURE_2D,W,wt,_t.width,_t.height,0,_t.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):It?L&&e.texSubImage2D(i.TEXTURE_2D,W,0,0,_t.width,_t.height,mt,Tt,_t.data):e.texImage2D(i.TEXTURE_2D,W,wt,_t.width,_t.height,0,mt,Tt,_t.data)}else if(A.isDataArrayTexture)if(It){if(ee&&e.texStorage3D(i.TEXTURE_2D_ARRAY,ot,wt,et.width,et.height,et.depth),L)if(A.layerUpdates.size>0){const W=lf(et.width,et.height,A.format,A.type);for(const Z of A.layerUpdates){const ht=et.data.subarray(Z*W/et.data.BYTES_PER_ELEMENT,(Z+1)*W/et.data.BYTES_PER_ELEMENT);e.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,Z,et.width,et.height,1,mt,Tt,ht)}A.clearLayerUpdates()}else e.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,et.width,et.height,et.depth,mt,Tt,et.data)}else e.texImage3D(i.TEXTURE_2D_ARRAY,0,wt,et.width,et.height,et.depth,0,mt,Tt,et.data);else if(A.isData3DTexture)It?(ee&&e.texStorage3D(i.TEXTURE_3D,ot,wt,et.width,et.height,et.depth),L&&e.texSubImage3D(i.TEXTURE_3D,0,0,0,0,et.width,et.height,et.depth,mt,Tt,et.data)):e.texImage3D(i.TEXTURE_3D,0,wt,et.width,et.height,et.depth,0,mt,Tt,et.data);else if(A.isFramebufferTexture){if(ee)if(It)e.texStorage2D(i.TEXTURE_2D,ot,wt,et.width,et.height);else{let W=et.width,Z=et.height;for(let ht=0;ht<ot;ht++)e.texImage2D(i.TEXTURE_2D,ht,wt,W,Z,0,mt,Tt,null),W>>=1,Z>>=1}}else if(Ht.length>0){if(It&&ee){const W=St(Ht[0]);e.texStorage2D(i.TEXTURE_2D,ot,wt,W.width,W.height)}for(let W=0,Z=Ht.length;W<Z;W++)_t=Ht[W],It?L&&e.texSubImage2D(i.TEXTURE_2D,W,0,0,mt,Tt,_t):e.texImage2D(i.TEXTURE_2D,W,wt,mt,Tt,_t);A.generateMipmaps=!1}else if(It){if(ee){const W=St(et);e.texStorage2D(i.TEXTURE_2D,ot,wt,W.width,W.height)}L&&e.texSubImage2D(i.TEXTURE_2D,0,0,0,mt,Tt,et)}else e.texImage2D(i.TEXTURE_2D,0,wt,mt,Tt,et);m(A)&&p(K),xt.__version=j.version,A.onUpdate&&A.onUpdate(A)}R.__version=A.version}function $(R,A,O){if(A.image.length!==6)return;const K=ft(R,A),J=A.source;e.bindTexture(i.TEXTURE_CUBE_MAP,R.__webglTexture,i.TEXTURE0+O);const j=n.get(J);if(J.version!==j.__version||K===!0){e.activeTexture(i.TEXTURE0+O);const xt=qt.getPrimaries(qt.workingColorSpace),ct=A.colorSpace===xi?null:qt.getPrimaries(A.colorSpace),pt=A.colorSpace===xi||xt===ct?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,A.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,A.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,A.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,pt);const Gt=A.isCompressedTexture||A.image[0].isCompressedTexture,et=A.image[0]&&A.image[0].isDataTexture,mt=[];for(let Z=0;Z<6;Z++)!Gt&&!et?mt[Z]=_(A.image[Z],!0,r.maxCubemapSize):mt[Z]=et?A.image[Z].image:A.image[Z],mt[Z]=re(A,mt[Z]);const Tt=mt[0],wt=s.convert(A.format,A.colorSpace),_t=s.convert(A.type),Ht=S(A.internalFormat,wt,_t,A.colorSpace),It=A.isVideoTexture!==!0,ee=j.__version===void 0||K===!0,L=J.dataReady;let ot=T(A,Tt);bt(i.TEXTURE_CUBE_MAP,A);let W;if(Gt){It&&ee&&e.texStorage2D(i.TEXTURE_CUBE_MAP,ot,Ht,Tt.width,Tt.height);for(let Z=0;Z<6;Z++){W=mt[Z].mipmaps;for(let ht=0;ht<W.length;ht++){const ut=W[ht];A.format!==Cn?wt!==null?It?L&&e.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,ht,0,0,ut.width,ut.height,wt,ut.data):e.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,ht,Ht,ut.width,ut.height,0,ut.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):It?L&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,ht,0,0,ut.width,ut.height,wt,_t,ut.data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,ht,Ht,ut.width,ut.height,0,wt,_t,ut.data)}}}else{if(W=A.mipmaps,It&&ee){W.length>0&&ot++;const Z=St(mt[0]);e.texStorage2D(i.TEXTURE_CUBE_MAP,ot,Ht,Z.width,Z.height)}for(let Z=0;Z<6;Z++)if(et){It?L&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,0,0,0,mt[Z].width,mt[Z].height,wt,_t,mt[Z].data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,0,Ht,mt[Z].width,mt[Z].height,0,wt,_t,mt[Z].data);for(let ht=0;ht<W.length;ht++){const Dt=W[ht].image[Z].image;It?L&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,ht+1,0,0,Dt.width,Dt.height,wt,_t,Dt.data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,ht+1,Ht,Dt.width,Dt.height,0,wt,_t,Dt.data)}}else{It?L&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,0,0,0,wt,_t,mt[Z]):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,0,Ht,wt,_t,mt[Z]);for(let ht=0;ht<W.length;ht++){const ut=W[ht];It?L&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,ht+1,0,0,wt,_t,ut.image[Z]):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,ht+1,Ht,wt,_t,ut.image[Z])}}}m(A)&&p(i.TEXTURE_CUBE_MAP),j.__version=J.version,A.onUpdate&&A.onUpdate(A)}R.__version=A.version}function rt(R,A,O,K,J,j){const xt=s.convert(O.format,O.colorSpace),ct=s.convert(O.type),pt=S(O.internalFormat,xt,ct,O.colorSpace),Gt=n.get(A),et=n.get(O);if(et.__renderTarget=A,!Gt.__hasExternalTextures){const mt=Math.max(1,A.width>>j),Tt=Math.max(1,A.height>>j);J===i.TEXTURE_3D||J===i.TEXTURE_2D_ARRAY?e.texImage3D(J,j,pt,mt,Tt,A.depth,0,xt,ct,null):e.texImage2D(J,j,pt,mt,Tt,0,xt,ct,null)}e.bindFramebuffer(i.FRAMEBUFFER,R),Vt(A)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,K,J,et.__webglTexture,0,kt(A)):(J===i.TEXTURE_2D||J>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&J<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,K,J,et.__webglTexture,j),e.bindFramebuffer(i.FRAMEBUFFER,null)}function Q(R,A,O){if(i.bindRenderbuffer(i.RENDERBUFFER,R),A.depthBuffer){const K=A.depthTexture,J=K&&K.isDepthTexture?K.type:null,j=x(A.stencilBuffer,J),xt=A.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,ct=kt(A);Vt(A)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,ct,j,A.width,A.height):O?i.renderbufferStorageMultisample(i.RENDERBUFFER,ct,j,A.width,A.height):i.renderbufferStorage(i.RENDERBUFFER,j,A.width,A.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,xt,i.RENDERBUFFER,R)}else{const K=A.textures;for(let J=0;J<K.length;J++){const j=K[J],xt=s.convert(j.format,j.colorSpace),ct=s.convert(j.type),pt=S(j.internalFormat,xt,ct,j.colorSpace),Gt=kt(A);O&&Vt(A)===!1?i.renderbufferStorageMultisample(i.RENDERBUFFER,Gt,pt,A.width,A.height):Vt(A)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,Gt,pt,A.width,A.height):i.renderbufferStorage(i.RENDERBUFFER,pt,A.width,A.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function At(R,A){if(A&&A.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(e.bindFramebuffer(i.FRAMEBUFFER,R),!(A.depthTexture&&A.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const K=n.get(A.depthTexture);K.__renderTarget=A,(!K.__webglTexture||A.depthTexture.image.width!==A.width||A.depthTexture.image.height!==A.height)&&(A.depthTexture.image.width=A.width,A.depthTexture.image.height=A.height,A.depthTexture.needsUpdate=!0),q(A.depthTexture,0);const J=K.__webglTexture,j=kt(A);if(A.depthTexture.format===Kr)Vt(A)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,J,0,j):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,J,0);else if(A.depthTexture.format===os)Vt(A)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,J,0,j):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,J,0);else throw new Error("Unknown depthTexture format")}function Ct(R){const A=n.get(R),O=R.isWebGLCubeRenderTarget===!0;if(A.__boundDepthTexture!==R.depthTexture){const K=R.depthTexture;if(A.__depthDisposeCallback&&A.__depthDisposeCallback(),K){const J=()=>{delete A.__boundDepthTexture,delete A.__depthDisposeCallback,K.removeEventListener("dispose",J)};K.addEventListener("dispose",J),A.__depthDisposeCallback=J}A.__boundDepthTexture=K}if(R.depthTexture&&!A.__autoAllocateDepthBuffer){if(O)throw new Error("target.depthTexture not supported in Cube render targets");At(A.__webglFramebuffer,R)}else if(O){A.__webglDepthbuffer=[];for(let K=0;K<6;K++)if(e.bindFramebuffer(i.FRAMEBUFFER,A.__webglFramebuffer[K]),A.__webglDepthbuffer[K]===void 0)A.__webglDepthbuffer[K]=i.createRenderbuffer(),Q(A.__webglDepthbuffer[K],R,!1);else{const J=R.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,j=A.__webglDepthbuffer[K];i.bindRenderbuffer(i.RENDERBUFFER,j),i.framebufferRenderbuffer(i.FRAMEBUFFER,J,i.RENDERBUFFER,j)}}else if(e.bindFramebuffer(i.FRAMEBUFFER,A.__webglFramebuffer),A.__webglDepthbuffer===void 0)A.__webglDepthbuffer=i.createRenderbuffer(),Q(A.__webglDepthbuffer,R,!1);else{const K=R.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,J=A.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,J),i.framebufferRenderbuffer(i.FRAMEBUFFER,K,i.RENDERBUFFER,J)}e.bindFramebuffer(i.FRAMEBUFFER,null)}function Nt(R,A,O){const K=n.get(R);A!==void 0&&rt(K.__webglFramebuffer,R,R.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),O!==void 0&&Ct(R)}function ie(R){const A=R.texture,O=n.get(R),K=n.get(A);R.addEventListener("dispose",b);const J=R.textures,j=R.isWebGLCubeRenderTarget===!0,xt=J.length>1;if(xt||(K.__webglTexture===void 0&&(K.__webglTexture=i.createTexture()),K.__version=A.version,a.memory.textures++),j){O.__webglFramebuffer=[];for(let ct=0;ct<6;ct++)if(A.mipmaps&&A.mipmaps.length>0){O.__webglFramebuffer[ct]=[];for(let pt=0;pt<A.mipmaps.length;pt++)O.__webglFramebuffer[ct][pt]=i.createFramebuffer()}else O.__webglFramebuffer[ct]=i.createFramebuffer()}else{if(A.mipmaps&&A.mipmaps.length>0){O.__webglFramebuffer=[];for(let ct=0;ct<A.mipmaps.length;ct++)O.__webglFramebuffer[ct]=i.createFramebuffer()}else O.__webglFramebuffer=i.createFramebuffer();if(xt)for(let ct=0,pt=J.length;ct<pt;ct++){const Gt=n.get(J[ct]);Gt.__webglTexture===void 0&&(Gt.__webglTexture=i.createTexture(),a.memory.textures++)}if(R.samples>0&&Vt(R)===!1){O.__webglMultisampledFramebuffer=i.createFramebuffer(),O.__webglColorRenderbuffer=[],e.bindFramebuffer(i.FRAMEBUFFER,O.__webglMultisampledFramebuffer);for(let ct=0;ct<J.length;ct++){const pt=J[ct];O.__webglColorRenderbuffer[ct]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,O.__webglColorRenderbuffer[ct]);const Gt=s.convert(pt.format,pt.colorSpace),et=s.convert(pt.type),mt=S(pt.internalFormat,Gt,et,pt.colorSpace,R.isXRRenderTarget===!0),Tt=kt(R);i.renderbufferStorageMultisample(i.RENDERBUFFER,Tt,mt,R.width,R.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+ct,i.RENDERBUFFER,O.__webglColorRenderbuffer[ct])}i.bindRenderbuffer(i.RENDERBUFFER,null),R.depthBuffer&&(O.__webglDepthRenderbuffer=i.createRenderbuffer(),Q(O.__webglDepthRenderbuffer,R,!0)),e.bindFramebuffer(i.FRAMEBUFFER,null)}}if(j){e.bindTexture(i.TEXTURE_CUBE_MAP,K.__webglTexture),bt(i.TEXTURE_CUBE_MAP,A);for(let ct=0;ct<6;ct++)if(A.mipmaps&&A.mipmaps.length>0)for(let pt=0;pt<A.mipmaps.length;pt++)rt(O.__webglFramebuffer[ct][pt],R,A,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+ct,pt);else rt(O.__webglFramebuffer[ct],R,A,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+ct,0);m(A)&&p(i.TEXTURE_CUBE_MAP),e.unbindTexture()}else if(xt){for(let ct=0,pt=J.length;ct<pt;ct++){const Gt=J[ct],et=n.get(Gt);e.bindTexture(i.TEXTURE_2D,et.__webglTexture),bt(i.TEXTURE_2D,Gt),rt(O.__webglFramebuffer,R,Gt,i.COLOR_ATTACHMENT0+ct,i.TEXTURE_2D,0),m(Gt)&&p(i.TEXTURE_2D)}e.unbindTexture()}else{let ct=i.TEXTURE_2D;if((R.isWebGL3DRenderTarget||R.isWebGLArrayRenderTarget)&&(ct=R.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),e.bindTexture(ct,K.__webglTexture),bt(ct,A),A.mipmaps&&A.mipmaps.length>0)for(let pt=0;pt<A.mipmaps.length;pt++)rt(O.__webglFramebuffer[pt],R,A,i.COLOR_ATTACHMENT0,ct,pt);else rt(O.__webglFramebuffer,R,A,i.COLOR_ATTACHMENT0,ct,0);m(A)&&p(ct),e.unbindTexture()}R.depthBuffer&&Ct(R)}function Ft(R){const A=R.textures;for(let O=0,K=A.length;O<K;O++){const J=A[O];if(m(J)){const j=y(R),xt=n.get(J).__webglTexture;e.bindTexture(j,xt),p(j),e.unbindTexture()}}}const ae=[],D=[];function fn(R){if(R.samples>0){if(Vt(R)===!1){const A=R.textures,O=R.width,K=R.height;let J=i.COLOR_BUFFER_BIT;const j=R.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,xt=n.get(R),ct=A.length>1;if(ct)for(let pt=0;pt<A.length;pt++)e.bindFramebuffer(i.FRAMEBUFFER,xt.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+pt,i.RENDERBUFFER,null),e.bindFramebuffer(i.FRAMEBUFFER,xt.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+pt,i.TEXTURE_2D,null,0);e.bindFramebuffer(i.READ_FRAMEBUFFER,xt.__webglMultisampledFramebuffer),e.bindFramebuffer(i.DRAW_FRAMEBUFFER,xt.__webglFramebuffer);for(let pt=0;pt<A.length;pt++){if(R.resolveDepthBuffer&&(R.depthBuffer&&(J|=i.DEPTH_BUFFER_BIT),R.stencilBuffer&&R.resolveStencilBuffer&&(J|=i.STENCIL_BUFFER_BIT)),ct){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,xt.__webglColorRenderbuffer[pt]);const Gt=n.get(A[pt]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,Gt,0)}i.blitFramebuffer(0,0,O,K,0,0,O,K,J,i.NEAREST),l===!0&&(ae.length=0,D.length=0,ae.push(i.COLOR_ATTACHMENT0+pt),R.depthBuffer&&R.resolveDepthBuffer===!1&&(ae.push(j),D.push(j),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,D)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,ae))}if(e.bindFramebuffer(i.READ_FRAMEBUFFER,null),e.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),ct)for(let pt=0;pt<A.length;pt++){e.bindFramebuffer(i.FRAMEBUFFER,xt.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+pt,i.RENDERBUFFER,xt.__webglColorRenderbuffer[pt]);const Gt=n.get(A[pt]).__webglTexture;e.bindFramebuffer(i.FRAMEBUFFER,xt.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+pt,i.TEXTURE_2D,Gt,0)}e.bindFramebuffer(i.DRAW_FRAMEBUFFER,xt.__webglMultisampledFramebuffer)}else if(R.depthBuffer&&R.resolveDepthBuffer===!1&&l){const A=R.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[A])}}}function kt(R){return Math.min(r.maxSamples,R.samples)}function Vt(R){const A=n.get(R);return R.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&A.__useRenderToTexture!==!1}function Mt(R){const A=a.render.frame;u.get(R)!==A&&(u.set(R,A),R.update())}function re(R,A){const O=R.colorSpace,K=R.format,J=R.type;return R.isCompressedTexture===!0||R.isVideoTexture===!0||O!==ls&&O!==xi&&(qt.getTransfer(O)===Zt?(K!==Cn||J!==li)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",O)),A}function St(R){return typeof HTMLImageElement<"u"&&R instanceof HTMLImageElement?(c.width=R.naturalWidth||R.width,c.height=R.naturalHeight||R.height):typeof VideoFrame<"u"&&R instanceof VideoFrame?(c.width=R.displayWidth,c.height=R.displayHeight):(c.width=R.width,c.height=R.height),c}this.allocateTextureUnit=N,this.resetTextureUnits=z,this.setTexture2D=q,this.setTexture2DArray=V,this.setTexture3D=Y,this.setTextureCube=H,this.rebindTextures=Nt,this.setupRenderTarget=ie,this.updateRenderTargetMipmap=Ft,this.updateMultisampleRenderTarget=fn,this.setupDepthRenderbuffer=Ct,this.setupFrameBufferTexture=rt,this.useMultisampledRTT=Vt}function xS(i,t){function e(n,r=xi){let s;const a=qt.getTransfer(r);if(n===li)return i.UNSIGNED_BYTE;if(n===$c)return i.UNSIGNED_SHORT_4_4_4_4;if(n===jc)return i.UNSIGNED_SHORT_5_5_5_1;if(n===dd)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===fd)return i.BYTE;if(n===hd)return i.SHORT;if(n===zs)return i.UNSIGNED_SHORT;if(n===Yc)return i.INT;if(n===mr)return i.UNSIGNED_INT;if(n===ni)return i.FLOAT;if(n===qs)return i.HALF_FLOAT;if(n===pd)return i.ALPHA;if(n===md)return i.RGB;if(n===Cn)return i.RGBA;if(n===_d)return i.LUMINANCE;if(n===gd)return i.LUMINANCE_ALPHA;if(n===Kr)return i.DEPTH_COMPONENT;if(n===os)return i.DEPTH_STENCIL;if(n===vd)return i.RED;if(n===Kc)return i.RED_INTEGER;if(n===xd)return i.RG;if(n===Zc)return i.RG_INTEGER;if(n===Jc)return i.RGBA_INTEGER;if(n===Pa||n===Da||n===La||n===Ia)if(a===Zt)if(s=t.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(n===Pa)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===Da)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===La)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===Ia)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=t.get("WEBGL_compressed_texture_s3tc"),s!==null){if(n===Pa)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===Da)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===La)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===Ia)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===Hl||n===Gl||n===Wl||n===Xl)if(s=t.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(n===Hl)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===Gl)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===Wl)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===Xl)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===ql||n===Yl||n===$l)if(s=t.get("WEBGL_compressed_texture_etc"),s!==null){if(n===ql||n===Yl)return a===Zt?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(n===$l)return a===Zt?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===jl||n===Kl||n===Zl||n===Jl||n===Ql||n===tc||n===ec||n===nc||n===ic||n===rc||n===sc||n===ac||n===oc||n===lc)if(s=t.get("WEBGL_compressed_texture_astc"),s!==null){if(n===jl)return a===Zt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===Kl)return a===Zt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===Zl)return a===Zt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===Jl)return a===Zt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===Ql)return a===Zt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===tc)return a===Zt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===ec)return a===Zt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===nc)return a===Zt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===ic)return a===Zt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===rc)return a===Zt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===sc)return a===Zt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===ac)return a===Zt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===oc)return a===Zt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===lc)return a===Zt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===Ua||n===cc||n===uc)if(s=t.get("EXT_texture_compression_bptc"),s!==null){if(n===Ua)return a===Zt?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===cc)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===uc)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===Ad||n===fc||n===hc||n===dc)if(s=t.get("EXT_texture_compression_rgtc"),s!==null){if(n===Ua)return s.COMPRESSED_RED_RGTC1_EXT;if(n===fc)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===hc)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===dc)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===as?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:e}}const AS={type:"move"};class nl{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new Sa,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new Sa,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new G,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new G),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new Sa,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new G,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new G),this._grip}dispatchEvent(t){return this._targetRay!==null&&this._targetRay.dispatchEvent(t),this._grip!==null&&this._grip.dispatchEvent(t),this._hand!==null&&this._hand.dispatchEvent(t),this}connect(t){if(t&&t.hand){const e=this._hand;if(e)for(const n of t.hand.values())this._getHandJoint(e,n)}return this.dispatchEvent({type:"connected",data:t}),this}disconnect(t){return this.dispatchEvent({type:"disconnected",data:t}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(t,e,n){let r=null,s=null,a=null;const o=this._targetRay,l=this._grip,c=this._hand;if(t&&e.session.visibilityState!=="visible-blurred"){if(c&&t.hand){a=!0;for(const _ of t.hand.values()){const m=e.getJointPose(_,n),p=this._getHandJoint(c,_);m!==null&&(p.matrix.fromArray(m.transform.matrix),p.matrix.decompose(p.position,p.rotation,p.scale),p.matrixWorldNeedsUpdate=!0,p.jointRadius=m.radius),p.visible=m!==null}const u=c.joints["index-finger-tip"],f=c.joints["thumb-tip"],h=u.position.distanceTo(f.position),d=.02,g=.005;c.inputState.pinching&&h>d+g?(c.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:t.handedness,target:this})):!c.inputState.pinching&&h<=d-g&&(c.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:t.handedness,target:this}))}else l!==null&&t.gripSpace&&(s=e.getPose(t.gripSpace,n),s!==null&&(l.matrix.fromArray(s.transform.matrix),l.matrix.decompose(l.position,l.rotation,l.scale),l.matrixWorldNeedsUpdate=!0,s.linearVelocity?(l.hasLinearVelocity=!0,l.linearVelocity.copy(s.linearVelocity)):l.hasLinearVelocity=!1,s.angularVelocity?(l.hasAngularVelocity=!0,l.angularVelocity.copy(s.angularVelocity)):l.hasAngularVelocity=!1));o!==null&&(r=e.getPose(t.targetRaySpace,n),r===null&&s!==null&&(r=s),r!==null&&(o.matrix.fromArray(r.transform.matrix),o.matrix.decompose(o.position,o.rotation,o.scale),o.matrixWorldNeedsUpdate=!0,r.linearVelocity?(o.hasLinearVelocity=!0,o.linearVelocity.copy(r.linearVelocity)):o.hasLinearVelocity=!1,r.angularVelocity?(o.hasAngularVelocity=!0,o.angularVelocity.copy(r.angularVelocity)):o.hasAngularVelocity=!1,this.dispatchEvent(AS)))}return o!==null&&(o.visible=r!==null),l!==null&&(l.visible=s!==null),c!==null&&(c.visible=a!==null),this}_getHandJoint(t,e){if(t.joints[e.jointName]===void 0){const n=new Sa;n.matrixAutoUpdate=!1,n.visible=!1,t.joints[e.jointName]=n,t.add(n)}return t.joints[e.jointName]}}const MS=`
void main() {
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
      ...
      `,_=new ui({vertexShader:d,fragmentShader:g,uniforms:{u_time:{value:0}},transparent:!0}),m=new kv(h,_);r.add(m);const p=new Xv;let y;const S=()=>{y=requestAnimationFrame(S),_.uniforms.u_time.value=p.getElapsedTime(),m.rotation.x-=2e-5,m.rotation.y-=5e-5,a.render(r,s)};return S(),()=>{cancelAnimationFrame(y),window.removeEventListener("resize",o),a.dispose(),h.dispose(),_.dispose()}}),vr();var n=CS();ti(n,r=>pe(e,r),()=>st(e)),de(i,n),Oi()}var DS=Be(`<div class="section svelte-926n32">This is the 'This' section.</div>`),LS=Be('<div class="main-wrapper svelte-926n32"><div class="transition-overlay svelte-926n32"><!></div> <!> <div class="container-main svelte-926n32"><div class="background svelte-926n32"><!></div> <!> <!> <!></div></div>');function IS(i,t){Fi(t,!1);let e=gn("Projects"),n=gn(),r=gn();function s(T){if(T===st(e))return;const w=bi.timeline({onComplete:()=>{pe(e,T),bi.to(st(n),{autoAlpha:0,duration:.2,zIndex:-9999}),bi.to(".container-main",{scale:1})}});st(r).restartAnimation(),w.to(st(n),{autoAlpha:1,duration:.2,zIndex:9999}).to(".container-main",{scale:1.1},"<").to({},{duration:.5})}let o=Object.entries(Object.assign({"../assets/img/Arena.png":dm,"../assets/img/Arinere.png":mm,"../assets/img/Darkada.png":gm,"../assets/img/Fucking Huindai Accent.png":xm,"../assets/img/Haneko.png":Mm,"../assets/img/Lesiana.png":Em,"../assets/img/Lusien.png":Tm,"../assets/img/Matsubara.png":wm,"../assets/img/Mika.png":Cm,"../assets/img/Mikota.png":Dm,"../assets/img/Misoto.png":Im,"../assets/img/Remasa.png":Nm,"../assets/img/Romata.png":Om,"../assets/img/Severenah.png":zm,"../assets/img/Slatora.png":Vm,"../assets/img/Taganrog.png":Gm})).map(([T,w])=>{const b=T.split("/").pop().replace(".png","");return{src:w.default,title:`Project: ${b}`,desc:`This is a description of the project: ${b}. You can provide any details here.`}});o.sort(()=>.5-Math.random()),vr();var l=LS(),c=me(l),u=me(c);ti(od(u,{$$legacy:!0}),T=>pe(r,T),()=>st(r)),ti(c,T=>pe(n,T),()=>st(n));var f=Ee(c,2);Qm(f,{get activeSection(){return st(e)},setActiveSection:s});var h=Ee(f,2),d=me(h),g=me(d);PS(g,{});var _=Ee(d,2);{var m=T=>{xg(T)};Xr(_,T=>{st(e)==="Me"&&T(m)})}var p=Ee(_,2);{var y=T=>{gg(T,{images:o})};Xr(p,T=>{st(e)==="Projects"&&T(y)})}var S=Ee(p,2);{var x=T=>{var w=DS();de(T,w)};Xr(S,T=>{st(e)==="This"&&T(x)})}de(i,l),Oi()}var US=Be('<div class="black-overlay svelte-1bwvu60"><!></div> <div class="overlay"><!></div>',1);function NS(i,t){Fi(t,!1),Ws(()=>{bi.timeline().to(".black-overlay",{autoAlpha:1}).to(".black-overlay",{autoAlpha:0},"+=1")}),vr();var e=US(),n=Ep(e),r=me(n);od(r,{});var s=Ee(n,2),a=me(s);IS(a,{}),de(i,e),Oi()}Yp(NS,{target:document.getElementById("app")});
